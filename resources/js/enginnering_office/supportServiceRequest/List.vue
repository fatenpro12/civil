    ...
    methods: {
        ...
        viewDesignPrice(item,office_id){
           ...
           let pdf_data=[
            item,item.media[0],
            office_id,'owner',
            'enginner_office/acceptSupportServiceRequestOffer',
            'enginner_office/rejectSupoortServiceRequestOffer'
           ]
        ...
        trash(id) {
            ...
            self.$store.commit('showDialog', {
                ...
                okCb: () => {
                    axios
                        .delete('/enginner_office/request-support-service/' + id)
        ...
        loadDesigns(cb) {
            ...
            axios.get('/enginner_office/request-support-service', { params: params }).then(function (response) {
                if (response.data.success === true) {
