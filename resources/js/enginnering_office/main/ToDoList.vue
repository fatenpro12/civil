<template>
                        ...
                        <v-layout wrap>
                            ...
                            <v-flex xs12 sm12 md4 v-if="$can('tickets.view')">
                                    ...
                                    >
                                        ...
                                        @click="$router.push({name: 'contractor_request_engineering_list'})">
                                            <v-card-text>
                                                <div class="text-md-center mt-2">
                                                    <p
                                                        x-large
    ...
    <!--add after edititng -->
                            <v-flex xs12 sm12 md4 v-if="$can('tickets.view')">
                                    ...
                                    >
                                        <v-card :elevation="hover ? 16 : 2"
                                         @click="
                                                $router.push({ name: 'support-service_engineer_list' })
                                            ">
                                            <v-card-text>
                                                <div class="text-md-center mt-2">
                                                    <p
                            ...
                            <v-flex xs12 sm12 md4 v-if="$can('employee.view') && $hasRole('Engineering Office Manager')">
                                    <v-hover
                                        v-slot:default="{ hover }"
                                        open-delay="100"
                                        close-delay="100"
