            ...
            >
                <template slot="headerCell" slot-scope="props">
                    ...
                    <span v-else-if="props.header.value == 'total'">
                        <v-icon>money</v-icon> {{ props.header.text }}
                    </span>
...
backBtn: true
    ...
    data() {
        ...
        return {
            ...
            headers: [
                ...
                {
                    text: self.trans('messages.total'),
                    value: 'total',
                    align: 'left',
                    sortable: true,
                },
    ...
    methods: {
        ...
        view(transaction_id) {
            ...
            var data = { transaction_id: transaction_id, project_id: self.projectId };
        ...
        edit(transaction_id) {
            ...
            self.$router.push({
                name: 'invoices.edit',
                params: { id: transaction_id, project_id: self.projectId },
            });
        },
